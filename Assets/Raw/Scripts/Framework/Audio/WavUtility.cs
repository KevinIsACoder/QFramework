...
public class WavUtility
{
    ...
    public static AudioClip ToAudioClipFromString(string filePath)
    {
    ...
    {
        return FromAudioClip(audioClip);
    }

    public static byte[] FromAudioClip(AudioClip audioClip,  bool saveAsFile = false,  string filepath = null)
    {
        ...
        if (saveAsFile && !string.IsNullOrEmpty(filepath))
        {
